...
- **Optional** `append-file`: Preserves changelog file by appending releases. Default `false`.
- **Optional** `reverse-file`: Change chronological order in changelog. Default `false`.
